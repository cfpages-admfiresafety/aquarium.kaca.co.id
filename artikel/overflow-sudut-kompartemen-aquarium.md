...
- **Writer task:** Expand this file into one complete article answering: “Overflow, Sudut, dan Kompartemen pada Desain Custom”
...
- **Primary intent:** Coordinate internal geometry with circulation, seams, access, and livestock.
...
- **Scope boundary:** Owns custom layout; hydraulic equipment belongs to AKU-08.
- **Final public route:** `/artikel/overflow-sudut-kompartemen-aquarium.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Overflow, Sudut, dan Kompartemen pada Desain Custom**.
...
- **Tie back to this article:** Keep the explanation specific to “Overflow, Sudut, dan Kompartemen pada Desain Custom”.
