---
article_id: AKU-10-02
title: "Mengapa Stocking Tidak Bisa Berdasarkan Liter Saja"
slug: "stocking-bukan-berdasarkan-liter-saja"
...
date_modified: null
parent_topic: AKU-10
primary_intent: "Account for biomass, behavior, filtration, oxygen, maintenance, and growth."
reader_community: "Kaca.co.id"
reader_address: "Teman Kaca.co.id"
final_route: "/artikel/stocking-bukan-berdasarkan-liter-saja.html"
...
# Mengapa Stocking Tidak Bisa Berdasarkan Liter Saja

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Mengapa Stocking Tidak Bisa Berdasarkan Liter Saja”
...
- **Primary intent:** Account for biomass, behavior, filtration, oxygen, maintenance, and growth.
...
- **Scope boundary:** Owns stocking caveat; exact plans require qualified husbandry review.
- **Final public route:** `/artikel/stocking-bukan-berdasarkan-liter-saja.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Mengapa Stocking Tidak Bisa Berdasarkan Liter Saja**.
...
- `AKU-10-01` → `/artikel/dimensi-aquarium-dari-perilaku-ikan.html` — Memilih Dimensi Aquarium dari Perilaku Ikan
...
- **Tie back to this article:** Keep the explanation specific to “Mengapa Stocking Tidak Bisa Berdasarkan Liter Saja”.
