---
article_id: AKU-14-04
title: "Checklist Inspeksi Seam, Base, dan Stand"
slug: "checklist-inspeksi-seam-base-stand"
...
date_modified: null
parent_topic: AKU-14
primary_intent: "Record visual change, moisture, level, movement, corrosion, and access."
reader_community: "Kaca.co.id"
reader_address: "Teman Kaca.co.id"
final_route: "/artikel/checklist-inspeksi-seam-base-stand.html"
...
# Checklist Inspeksi Seam, Base, dan Stand

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Checklist Inspeksi Seam, Base, dan Stand”
...
- **Primary intent:** Record visual change, moisture, level, movement, corrosion, and access.
...
- **Scope boundary:** Owns periodic inspection; existing leak/crack routes own symptoms.
- **Final public route:** `/artikel/checklist-inspeksi-seam-base-stand.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Checklist Inspeksi Seam, Base, dan Stand**.
...
- `AKU-14-03` → `/artikel/urutan-water-change-dan-pembersihan.html` — Urutan Water Change dan Pembersihan Kaca
- `AKU-14-05` → `/artikel/log-perawatan-aquarium.html` — Membuat Log Perawatan Aquarium
- `AKU-14-06` → `/artikel/perbaiki-atau-ganti-aquarium.html` — Kapan Aquarium Diperbaiki atau Diganti
...
- **Tie back to this article:** Keep the explanation specific to “Checklist Inspeksi Seam, Base, dan Stand”.
