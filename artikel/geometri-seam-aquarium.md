---
article_id: AKU-05-03
title: "Geometri Seam dan Bond Line Aquarium"
slug: "geometri-seam-aquarium"
...
date_modified: null
parent_topic: AKU-05
primary_intent: "Understand joint gap, contact, fillet, movement, and inspection questions."
reader_community: "Kaca.co.id"
reader_address: "Sobat Kaca.co.id"
final_route: "/artikel/geometri-seam-aquarium.html"
...
# Geometri Seam dan Bond Line Aquarium

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Geometri Seam dan Bond Line Aquarium”
...
- **Primary intent:** Understand joint gap, contact, fillet, movement, and inspection questions.
...
- **Scope boundary:** Owns seam geometry; load calculation belongs to AKU-03.
- **Final public route:** `/artikel/geometri-seam-aquarium.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Geometri Seam dan Bond Line Aquarium**.
...
- `AKU-05-01` → `/artikel/silicone-aquarium-vs-sealant-konstruksi.html` — Silicone Aquarium vs Sealant Konstruksi
- `AKU-05-02` → `/artikel/persiapan-permukaan-silicone-kaca.html` — Persiapan Permukaan sebelum Silicone Kaca
- `AKU-05-04` → `/artikel/cure-time-silicone-aquarium.html` — Cure Time Silicone sebelum Leak Test
...
- **Tie back to this article:** Keep the explanation specific to “Geometri Seam dan Bond Line Aquarium”.
