---
article_id: AKU-04-05
title: "Aquarium Kaca Cermin dan Backing Reflektif"
slug: "aquarium-kaca-cermin"
...
date_modified: null
parent_topic: AKU-04
primary_intent: "Understand reflection, backing protection, viewing, cleaning, and livestock stress questions."
reader_community: "Kaca.co.id"
reader_address: "Kawan Kaca.co.id"
final_route: "/artikel/aquarium-kaca-cermin.html"
...
# Aquarium Kaca Cermin dan Backing Reflektif

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Aquarium Kaca Cermin dan Backing Reflektif”
...
- **Primary intent:** Understand reflection, backing protection, viewing, cleaning, and livestock stress questions.
...
- **Scope boundary:** Owns reflective design; animal suitability belongs to AKU-10.
- **Final public route:** `/artikel/aquarium-kaca-cermin.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Aquarium Kaca Cermin dan Backing Reflektif**.
...
- **Exact Markdown to insert:** `![Ilustrasi aquarium kaca cermin](/wp-content/uploads/2022/02/aquarium-kaca-cermin.jpg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `aquarium kaca cermin` as relevant content media; no pixels were inspected.
...
- **Tie back to this article:** Keep the explanation specific to “Aquarium Kaca Cermin dan Backing Reflektif”.
