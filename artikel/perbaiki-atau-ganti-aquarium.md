...
- **Writer task:** Expand this file into one complete article answering: “Kapan Aquarium Diperbaiki atau Diganti”
...
- **Primary intent:** Escalate based on crack/seam, history, access, safety, cost, and evidence.
...
- **Scope boundary:** Owns lifecycle decision; no repair method for structural glass is improvised.
- **Final public route:** `/artikel/perbaiki-atau-ganti-aquarium.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Kapan Aquarium Diperbaiki atau Diganti**.
...
- **Tie back to this article:** Keep the explanation specific to “Kapan Aquarium Diperbaiki atau Diganti”.
