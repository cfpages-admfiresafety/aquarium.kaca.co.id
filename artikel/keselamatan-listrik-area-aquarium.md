---
article_id: AKU-11-03
title: "Drip Loop, RCD, dan Isolasi Listrik di Area Basah"
slug: "keselamatan-listrik-area-aquarium"
description: "Coordinate light, heat, controls, cables, moisture, isolation, and maintenance access."
status: outline
publication_date: "2026-03-22"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: AKU-11
primary_intent: "Identify critical wet-area electrical safeguards."
reader_community: "Kaca.co.id"
reader_address: "Sobat Kaca.co.id"
final_route: "/artikel/keselamatan-listrik-area-aquarium.html"
...
# Drip Loop, RCD, dan Isolasi Listrik di Area Basah

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Drip Loop, RCD, dan Isolasi Listrik di Area Basah”
- **Reader and situation:** Coordinate light, heat, controls, cables, moisture, isolation, and maintenance access.
- **Reader outcome:** Coordinate light, heat, controls, cables, moisture, isolation, and maintenance access.
- **Primary intent:** Identify critical wet-area electrical safeguards.
...
- **Scope boundary:** Owns safety orientation; installation requires a qualified electrician and current rules.
- **Final public route:** `/artikel/keselamatan-listrik-area-aquarium.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Drip Loop, RCD, dan Isolasi Listrik di Area Basah**.
...
- **Limits:** If current site/operator proof is absent, keep the article neutral and mark the evidence gap.
...
- `AKU-11-01` → `/artikel/tujuan-lighting-aquarium.html` — Menentukan Tujuan Lighting Aquarium
- `AKU-11-02` → `/artikel/heater-chiller-kontrol-suhu-aquarium.html` — Heater, Chiller, dan Kontrol Suhu
- `AKU-11-04` → `/artikel/manajemen-kabel-aquarium.html` — Manajemen Kabel dan Power Strip Aquarium
- `AKU-11-05` → `/artikel/sensor-controller-alarm-aquarium.html` — Sensor, Controller, dan Alarm Aquarium
...
- **Tie back to this article:** Keep the explanation specific to “Drip Loop, RCD, dan Isolasi Listrik di Area Basah”.
