...
- **Writer task:** Expand this file into one complete article answering: “Penempatan dan Leveling Aquarium di Lokasi”
...
- **Primary intent:** Sequence support checks, positioning, leveling, and no-load inspection.
...
- **Scope boundary:** Owns placement execution; stand requirements belong to AKU-06.
- **Final public route:** `/artikel/penempatan-dan-leveling-aquarium.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Penempatan dan Leveling Aquarium di Lokasi**.
...
- `AKU-07-01` → `/artikel/checklist-pengiriman-aquarium-kaca.html` — Checklist Pengiriman dan Pengangkatan Aquarium Kaca
- `AKU-07-02` → `/artikel/mengukur-jalur-masuk-aquarium.html` — Mengukur Jalur Masuk sebelum Aquarium Dikirim
- `AKU-07-04` → `/artikel/leak-test-bertahap-aquarium.html` — Leak Test Bertahap sebelum Aquarium Dioperasikan
...
- **Tie back to this article:** Keep the explanation specific to “Penempatan dan Leveling Aquarium di Lokasi”.
