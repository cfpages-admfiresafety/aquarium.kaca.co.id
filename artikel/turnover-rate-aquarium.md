...
- **Writer task:** Expand this file into one complete article answering: “Turnover Rate Bukan Satu Angka untuk Semua Aquarium”
...
- **Primary intent:** Evaluate flow against livestock, media, head loss, layout, and maintenance.
...
- **Scope boundary:** Owns flow-claim caveat; exact sizing requires system evidence.
- **Final public route:** `/artikel/turnover-rate-aquarium.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Turnover Rate Bukan Satu Angka untuk Semua Aquarium**.
...
- **Tie back to this article:** Keep the explanation specific to “Turnover Rate Bukan Satu Angka untuk Semua Aquarium”.
