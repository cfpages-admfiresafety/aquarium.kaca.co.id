---
article_id: AKU-08-03
title: "Sump vs Canister Filter"
slug: "sump-vs-canister-filter"
...
date_modified: null
parent_topic: AKU-08
primary_intent: "Compare capacity, access, plumbing, noise, leakage, and failure modes."
reader_community: "Kaca.co.id"
reader_address: "Sobat Kaca.co.id"
final_route: "/artikel/sump-vs-canister-filter.html"
...
- **Writer task:** Expand this file into one complete article answering: “Sump vs Canister Filter”
...
- **Primary intent:** Compare capacity, access, plumbing, noise, leakage, and failure modes.
...
- **Scope boundary:** Owns filter-system comparison; custom overflow geometry belongs to AKU-04.
- **Final public route:** `/artikel/sump-vs-canister-filter.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Sump vs Canister Filter**.
...
- `AKU-08-01` → `/artikel/jenis-filtrasi-aquarium.html` — Jenis Filtrasi Aquarium dan Fungsi Masing-Masing
- `AKU-08-02` → `/artikel/turnover-rate-aquarium.html` — Turnover Rate Bukan Satu Angka untuk Semua Aquarium
- `AKU-08-04` → `/artikel/urutan-media-filter-aquarium.html` — Urutan Media Filter dan Jalur Air
- `AKU-08-05` → `/artikel/aerasi-dan-oksigen-aquarium.html` — Aerasi, Surface Agitation, dan Oksigen
...
- **Tie back to this article:** Keep the explanation specific to “Sump vs Canister Filter”.
