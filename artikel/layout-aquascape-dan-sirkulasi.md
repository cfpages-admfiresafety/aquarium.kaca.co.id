---
article_id: AKU-12-04
title: "Layout Aquascape dan Jalur Sirkulasi"
slug: "layout-aquascape-dan-sirkulasi"
...
date_modified: null
parent_topic: AKU-12
primary_intent: "Avoid dead zones while preserving habitat and visual intent."
reader_community: "Kaca.co.id"
reader_address: "Teman Kaca.co.id"
final_route: "/artikel/layout-aquascape-dan-sirkulasi.html"
...
# Layout Aquascape dan Jalur Sirkulasi

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Layout Aquascape dan Jalur Sirkulasi”
...
- **Primary intent:** Avoid dead zones while preserving habitat and visual intent.
...
- **Scope boundary:** Owns layout-flow interaction; pump/filter sizing belongs to AKU-08.
- **Final public route:** `/artikel/layout-aquascape-dan-sirkulasi.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Layout Aquascape dan Jalur Sirkulasi**.
...
- `AKU-12-03` → `/artikel/material-dekorasi-aquarium.html` — Memilih Material Dekorasi yang Kompatibel dengan Air
- `AKU-12-05` → `/artikel/substrate-aquarium-tanaman.html` — Substrate untuk Tanaman dan Area Tanpa Tanaman
- `AKU-12-06` → `/artikel/akses-bersih-aquascape.html` — Menyediakan Akses Bersih dalam Aquascape Padat
...
- **Tie back to this article:** Keep the explanation specific to “Layout Aquascape dan Jalur Sirkulasi”.
