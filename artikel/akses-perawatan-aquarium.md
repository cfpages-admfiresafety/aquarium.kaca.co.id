---
article_id: AKU-01-04
title: "Merencanakan Akses Perawatan sejak Tahap Desain"
slug: "akses-perawatan-aquarium"
...
date_modified: null
parent_topic: AKU-01
primary_intent: "Reserve space for lids, equipment, cleaning, removal, and repairs."
reader_community: "Kaca.co.id"
reader_address: "Sobat Kaca.co.id"
final_route: "/artikel/akses-perawatan-aquarium.html"
...
# Merencanakan Akses Perawatan sejak Tahap Desain

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Merencanakan Akses Perawatan sejak Tahap Desain”
...
- **Primary intent:** Reserve space for lids, equipment, cleaning, removal, and repairs.
...
- **Scope boundary:** Owns maintainability requirements; maintenance workflow belongs to AKU-14.
- **Final public route:** `/artikel/akses-perawatan-aquarium.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Merencanakan Akses Perawatan sejak Tahap Desain**.
...
- `AKU-01-05` → `/artikel/brief-aquarium-air-tawar-vs-laut.html` — Brief Aquarium Air Tawar vs Air Laut
- `AKU-01-06` → `/artikel/aquarium-untuk-perubahan-kebutuhan.html` — Menyiapkan Aquarium untuk Perubahan Kebutuhan
...
- **Tie back to this article:** Keep the explanation specific to “Merencanakan Akses Perawatan sejak Tahap Desain”.
