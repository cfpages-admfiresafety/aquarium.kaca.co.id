---
article_id: AKU-06-02
title: "Foam Pad dan Alas di Bawah Aquarium"
slug: "foam-pad-dan-alas-aquarium"
...
date_modified: null
parent_topic: AKU-06
primary_intent: "Determine when a manufacturer/design calls for an interface layer."
reader_community: "Kaca.co.id"
reader_address: "Teman Kaca.co.id"
final_route: "/artikel/foam-pad-dan-alas-aquarium.html"
...
# Foam Pad dan Alas di Bawah Aquarium

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Foam Pad dan Alas di Bawah Aquarium”
...
- **Primary intent:** Determine when a manufacturer/design calls for an interface layer.
...
- **Scope boundary:** Owns tank-base interface; no universal pad rule is asserted.
- **Final public route:** `/artikel/foam-pad-dan-alas-aquarium.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Foam Pad dan Alas di Bawah Aquarium**.
...
- **Tie back to this article:** Keep the explanation specific to “Foam Pad dan Alas di Bawah Aquarium”.
