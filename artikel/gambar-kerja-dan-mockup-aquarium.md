---
article_id: AKU-15-04
title: "Gambar Kerja dan Mockup sebelum Fabrikasi Aquarium"
slug: "gambar-kerja-dan-mockup-aquarium"
...
date_modified: null
parent_topic: AKU-15
primary_intent: "Approve dimensions, openings, overflow, support, equipment, and access."
reader_community: "Kaca.co.id"
reader_address: "Sobat Kaca.co.id"
final_route: "/artikel/gambar-kerja-dan-mockup-aquarium.html"
...
# Gambar Kerja dan Mockup sebelum Fabrikasi Aquarium

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Gambar Kerja dan Mockup sebelum Fabrikasi Aquarium”
...
- **Primary intent:** Approve dimensions, openings, overflow, support, equipment, and access.
...
- **Scope boundary:** Owns pre-production approval; calculations belong to AKU-03/AKU-16.
- **Final public route:** `/artikel/gambar-kerja-dan-mockup-aquarium.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Gambar Kerja dan Mockup sebelum Fabrikasi Aquarium**.
...
- `AKU-15-06` → `/artikel/risiko-pengiriman-aquarium-kaca.html` — Pembagian Risiko Pengiriman Aquarium Kaca
...
- **Tie back to this article:** Keep the explanation specific to “Gambar Kerja dan Mockup sebelum Fabrikasi Aquarium”.
