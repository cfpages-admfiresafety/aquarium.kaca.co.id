---
article_id: AKU-06-04
title: "Memeriksa Kapasitas Lantai untuk Aquarium Besar"
slug: "kapasitas-lantai-untuk-aquarium-besar"
...
date_modified: null
parent_topic: AKU-06
primary_intent: "Gather load, position, framing, slab, and building evidence for an engineer."
reader_community: "Kaca.co.id"
reader_address: "Kawan Kaca.co.id"
final_route: "/artikel/kapasitas-lantai-untuk-aquarium-besar.html"
...
# Memeriksa Kapasitas Lantai untuk Aquarium Besar

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Memeriksa Kapasitas Lantai untuk Aquarium Besar”
...
- **Primary intent:** Gather load, position, framing, slab, and building evidence for an engineer.
...
- **Scope boundary:** Owns floor escalation; no capacity conclusion is provided.
- **Final public route:** `/artikel/kapasitas-lantai-untuk-aquarium-besar.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Memeriksa Kapasitas Lantai untuk Aquarium Besar**.
...
- **Tie back to this article:** Keep the explanation specific to “Memeriksa Kapasitas Lantai untuk Aquarium Besar”.
