---
article_id: AKU-13-02
title: "Aquarium Outdoor: Hujan, Panas, dan Perubahan Suhu"
slug: "aquarium-outdoor-hujan-panas"
...
date_modified: null
parent_topic: AKU-13
primary_intent: "Plan protection, drainage, shading, materials, and monitoring."
reader_community: "Kaca.co.id"
reader_address: "Sobat Kaca.co.id"
final_route: "/artikel/aquarium-outdoor-hujan-panas.html"
...
# Aquarium Outdoor: Hujan, Panas, dan Perubahan Suhu

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Aquarium Outdoor: Hujan, Panas, dan Perubahan Suhu”
...
- **Primary intent:** Plan protection, drainage, shading, materials, and monitoring.
...
- **Scope boundary:** Owns outdoor exposure; livestock limits require AKU-10 review.
- **Final public route:** `/artikel/aquarium-outdoor-hujan-panas.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Aquarium Outdoor: Hujan, Panas, dan Perubahan Suhu**.
...
- `/aquarium-outdoor/` — use only if it helps the reader's next step; verify the anchor describes the destination.
...
- `AKU-13-01` → `/artikel/memilih-lokasi-aquarium-indoor.html` — Memilih Lokasi Aquarium Indoor
...
- **Tie back to this article:** Keep the explanation specific to “Aquarium Outdoor: Hujan, Panas, dan Perubahan Suhu”.
