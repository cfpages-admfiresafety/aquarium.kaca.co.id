...
- **Writer task:** Expand this file into one complete article answering: “Kondensasi dan Kelembapan di Sekitar Aquarium”
...
- **Primary intent:** Control room surfaces, airflow, cabinet, mold risk, and records.
...
- **Scope boundary:** Owns environmental moisture; existing fog/mold routes own symptoms.
- **Final public route:** `/artikel/kondensasi-dan-kelembapan-aquarium.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Kondensasi dan Kelembapan di Sekitar Aquarium**.
...
- **Tie back to this article:** Keep the explanation specific to “Kondensasi dan Kelembapan di Sekitar Aquarium”.
