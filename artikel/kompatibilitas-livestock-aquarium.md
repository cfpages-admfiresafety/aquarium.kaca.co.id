---
article_id: AKU-10-03
title: "Kompatibilitas Livestock dalam Satu Aquarium"
slug: "kompatibilitas-livestock-aquarium"
...
date_modified: null
parent_topic: AKU-10
primary_intent: "Review behavior, size, habitat, diet, disease, and water needs."
reader_community: "Kaca.co.id"
reader_address: "Kawan Kaca.co.id"
final_route: "/artikel/kompatibilitas-livestock-aquarium.html"
...
# Kompatibilitas Livestock dalam Satu Aquarium

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Kompatibilitas Livestock dalam Satu Aquarium”
...
- **Primary intent:** Review behavior, size, habitat, diet, disease, and water needs.
...
- **Scope boundary:** Owns compatibility framework; no guarantee for specific combinations.
- **Final public route:** `/artikel/kompatibilitas-livestock-aquarium.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Kompatibilitas Livestock dalam Satu Aquarium**.
...
- **Tie back to this article:** Keep the explanation specific to “Kompatibilitas Livestock dalam Satu Aquarium”.
