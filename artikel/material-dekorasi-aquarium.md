---
article_id: AKU-12-03
title: "Memilih Material Dekorasi yang Kompatibel dengan Air"
slug: "material-dekorasi-aquarium"
description: "Plan layout, hardscape loads, substrate, planting, cleaning access, and material compatibility."
status: outline
publication_date: "2026-04-14"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: AKU-12
primary_intent: "Check leaching, sharpness, porosity, cleaning, and water-chemistry effects."
reader_community: "Kaca.co.id"
reader_address: "Kawan Kaca.co.id"
final_route: "/artikel/material-dekorasi-aquarium.html"
...
# Memilih Material Dekorasi yang Kompatibel dengan Air

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Memilih Material Dekorasi yang Kompatibel dengan Air”
- **Reader and situation:** Plan layout, hardscape loads, substrate, planting, cleaning access, and material compatibility.
- **Reader outcome:** Plan layout, hardscape loads, substrate, planting, cleaning access, and material compatibility.
- **Primary intent:** Check leaching, sharpness, porosity, cleaning, and water-chemistry effects.
...
- **Scope boundary:** Owns material compatibility; livestock suitability belongs to AKU-10.
- **Final public route:** `/artikel/material-dekorasi-aquarium.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Memilih Material Dekorasi yang Kompatibel dengan Air**.
...
- `AKU-12-01` → `/artikel/beban-substrate-dan-hardscape.html` — Menghitung Beban Substrate dan Hardscape
- `AKU-12-02` → `/artikel/melindungi-kaca-dari-point-load.html` — Melindungi Kaca dari Point Load Hardscape
- `AKU-12-04` → `/artikel/layout-aquascape-dan-sirkulasi.html` — Layout Aquascape dan Jalur Sirkulasi
- `AKU-12-05` → `/artikel/substrate-aquarium-tanaman.html` — Substrate untuk Tanaman dan Area Tanpa Tanaman
...
- **Tie back to this article:** Keep the explanation specific to “Memilih Material Dekorasi yang Kompatibel dengan Air”.
