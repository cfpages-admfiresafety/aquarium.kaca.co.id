...
- **Writer task:** Expand this file into one complete article answering: “Membuat Log Perawatan Aquarium”
...
- **Primary intent:** Track water tests, changes, equipment, livestock, defects, and actions.
...
- **Scope boundary:** Owns maintenance records; handover documents belong to AKU-16.
- **Final public route:** `/artikel/log-perawatan-aquarium.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Membuat Log Perawatan Aquarium**.
...
- **Tie back to this article:** Keep the explanation specific to “Membuat Log Perawatan Aquarium”.
