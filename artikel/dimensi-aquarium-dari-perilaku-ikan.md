---
article_id: AKU-10-01
title: "Memilih Dimensi Aquarium dari Perilaku Ikan"
slug: "dimensi-aquarium-dari-perilaku-ikan"
...
date_modified: null
parent_topic: AKU-10
primary_intent: "Consider swimming pattern, territory, depth use, and adult size."
reader_community: "Kaca.co.id"
reader_address: "Kawan Kaca.co.id"
final_route: "/artikel/dimensi-aquarium-dari-perilaku-ikan.html"
...
# Memilih Dimensi Aquarium dari Perilaku Ikan

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Memilih Dimensi Aquarium dari Perilaku Ikan”
...
- **Primary intent:** Consider swimming pattern, territory, depth use, and adult size.
...
- **Scope boundary:** Owns behavior-based geometry; no species prescription without expert evidence.
- **Final public route:** `/artikel/dimensi-aquarium-dari-perilaku-ikan.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Memilih Dimensi Aquarium dari Perilaku Ikan**.
...
- **Tie back to this article:** Keep the explanation specific to “Memilih Dimensi Aquarium dari Perilaku Ikan”.
